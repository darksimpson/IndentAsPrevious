...
#define IDM_EDIT_SORTLINES_LEXICOGRAPHIC_DESCENDIN    (IDM_EDIT + 60)
...
#define IDM_LANG_USER                                 (IDM_LANG + 80)
#define IDM_LANG_USER_LIMIT                           (IDM_LANG + 110)
