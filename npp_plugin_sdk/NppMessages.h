...
#ifndef NPPMESSAGES_H
#define NPPMESSAGES_H
...
enum winVer
{
	WV_UNKNOWN, WV_WIN32S, WV_95, WV_98, WV_ME, WV_NT, WV_W2K, WV_XP, WV_S2003, WV_XPX64, WV_VISTA, WV_WIN7
};
...
// use the command symbols defined in "NppMenuCommands.h" file
